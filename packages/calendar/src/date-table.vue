<script>
import fecha from 'element-ui-qz/src/utils/date';
import { range as rangeArr, getFirstDayOfMonth, getPrevMonthLastDays, getMonthDays, getI18nSettings, validateRangeInOneMonth } from 'element-ui-qz/src/utils/date-util';
export default {
